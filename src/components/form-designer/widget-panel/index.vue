<template>
    <el-scrollbar class="side-scroll-bar" style="height: auto">
        <div class="panel-container">

            <el-tabs v-model="firstTab" class="no-bottom-margin text-center">
                            ...
                            <draggable
                                ...
                                <template #item="{ element: fld }">
                                    <li class="field-widget-item" :title="fld.displayName" @dblclick="addFieldByDbClick(fld)">
                                        <span><svg-icon :icon-class="fld.icon" />{{fld.textName}}</span>
                                    </li>
                                </template>
                            </draggable>
                        </el-collapse-item>
...
.side-scroll-bar.layout-scrollbar {
	box-shadow: unset;
