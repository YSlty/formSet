<template>
  <div class="field-wrapper" :class="{'design-time-bottom-margin': !!this.designer}">
    <div :class="
    'static-content-item' + (labelAilgn === 'label-right-align' ? ' static-right-align' : (labelAilgn === 'label-center-align' ? '  static-center-align' : ' static-left-align')) + ( selected ? ' selected' : '') + customClass
    " v-show="!field.options.hidden || (designState === true)" @click.stop="selectField(field)">
      <slot></slot>
    </div>
